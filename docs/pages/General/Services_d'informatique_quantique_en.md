...
`<span id="Aperçu">`{=html}`</span>`{=html}

## Summary

Our team of quantum computing analysts provides expertise, support and training on quantum computing and hybrid classical-quantum computing. As of January, Calcul Québec offers access to a 24 qubit superconducting quantum computer called [MonarQ](https://docs.alliancecan.ca/MonarQ/en "wikilink"), available via the [Narval](https://docs.alliancecan.ca/Narval/en "wikilink") cluster. See our page [MonarQ](https://docs.alliancecan.ca/MonarQ "wikilink") for more details.

```{=html}
<div class="mw-translate-fuzzy">
```
See [Getting started](https://docs.alliancecan.ca/MonarQ/en#Getting_started "wikilink") on the [MonarQ](https://docs.alliancecan.ca/MonarQ "wikilink") page to get access to MonarQ.
...
-   [PennyLane](https://docs.alliancecan.ca/PennyLane/en "wikilink"), Python library
-   [Snowflurry](https://docs.alliancecan.ca/Snowflurry/en "wikilink"), Julia library
-   [Qiskit](https://docs.alliancecan.ca/Qiskit/fr "wikilink"), Python library

`<span id="Formation">`{=html}`</span>`{=html}
...
`<span id="Aide_à_la_recherche_et_soutien_technique">`{=html}`</span>`{=html}
