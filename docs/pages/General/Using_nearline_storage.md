...
3\. By using [Globus](https://docs.alliancecan.ca/Globus "Globus"){.wikilink} for transfers to and from HPSS using the endpoint `<b>`{=html}alliancecan#hpss`</b>`{=html}. This is useful for occasional usage and for transfers to and from other sites.
